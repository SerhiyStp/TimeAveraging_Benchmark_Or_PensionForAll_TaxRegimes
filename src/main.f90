program Laffer
    ...
    open(1,file='welfarepath_all.txt')
    ...
    open(1,file='welfarepathsingle_female.txt')
...
!Single female welfare ability 1
    ...
    open(1,file='welfarepathsingle_female_a1.txt')
...
!Single female welfare ability 1 and 2
    ...
    open(1,file='welfarepathsingle_female_a12.txt')
    ...
    open(1,file='welfarepathmarried_female.txt')
...
!Married female welfare ability 1
    ...
    open(1,file='welfarepathmarried_female_a1.txt')
...
!Married female welfare ability 1 and 2
    ...
    open(1,file='welfarepathmarried_female_a12.txt')
    ...
    open(1,file='welfarepathsingle_male.txt')
...
!Single male welfare ability 1
    ...
    open(1,file='welfarepathsingle_male_a1.txt')
...
!Single male welfare ability 1 and 2
    ...
    open(1,file='welfarepathsingle_male_a12.txt')
    ...
    open(1,file='welfarepathmarried_male.txt')
...
!Married male welfare ability 1
    ...
    open(1,file='welfarepathmarried_male_a1.txt')
...
!Married male welfare ability 1 and 2
    ...
    open(1,file='welfarepathmarried_male_a12.txt')
    ...
    open(1,file='earningspathm2.txt')
    ...
    open(1,file='lfppathmarried_auf.txt')
    ...
    open(1,file='lfppathmarriedmale_auf.txt')
    ...
    open(1,file='lfppathsingle_a.txt')
    ...
    open(1,file='lfppathsinglemale_a.txt')
    ...
    open(1,file='lfppathmarried_a.txt')
    ...
    open(1,file='lfppathmarriedmale_a.txt')
    ...
    open(1,file='lfppath_females_a.txt')
    ...
    open(1,file='lfppath_males_a.txt')
    ...
    open(1,file='earners_in_couples.txt')

    open(2,file='ability_couple_f_works.txt')
    ...
    open(1,file='lfppathsingle2.txt')
    ...
    open(1,file='lfppathmarried2.txt')
    ...
    open(1,file='lfppathsingle_male2.txt')
    ...
    open(1,file='lfppathmarried_male2.txt')
    ...
    open(1, file='Simulated_wealth_data.txt')
    ...
    open(1, file='Simulated_earnings_single_male.txt')
    ...
    open(1, file='Simulated_earnings_single_female.txt')
    ...
    open(1, file='Simulated_earnings_married.txt')
